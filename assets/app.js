...
(() => {
    ...
    return `
      <div class="rec-card">
        ...
        <div class="mt-3">
          ...
          <input type="date" class="form-control form-control-sm" value="${esc(fmtDate(pair.implementationDate||""))}" data-act="rep-impl-date" data-obs="${obs.id}" data-pair="${pair.id}" ${canMgmtEdit?"":"disabled"} />
        </div>
        ...
        ${canMgmtEdit ? `
          <div class="d-flex justify-content-end mt-3">
            <button class="btn btn-primary btn-sm ${mgmtSubmitDisabled}" data-act="rep-submit" data-obs="${obs.id}" data-pair="${pair.id}"><i class="fa fa-paper-plane me-1"></i>Submit</button>
          </div>` : ""}
    ...
    return `
      <div class="rec-card">
        ...
        <div class="mt-3">
          ...
          <input type="date" class="form-control form-control-sm" value="${esc(fmtDate(pair.implementationDate||""))}" disabled />
        </div>
        ...
        ${showNext ? `
          <div class="mt-3">
            ...
            <input type="date" class="form-control form-control-sm" data-act="fu-nextdate" data-obs="${obs.id}" data-pair="${pair.id}" value="${esc(fmtDate(fu.nextImplementationDate||""))}" ${canMgmtEdit?"":"disabled"} />
          </div>` : ""}
  ...
  function wireEvents(){
    ...
    root.onchange = (e) => {
      ...
      if(act==="rep-impl-date"){ pair.implementationDate = el.value; save(st); return; }
